...
def test_full_timer_and_part_timer_gets_their_positions_amount_of_shifts():
    ...
    test_shift1 = Shift(shift_id="test_shift1", shift_type=ShiftTypesEnum.MORNING, start_time=test_shift1_start_time, end_time=test_shift1_start_time + shift_duration)
    test_shift2 = Shift(shift_id="test_shift2", shift_type=ShiftTypesEnum.MORNING_BACKUP, start_time=test_shift1.end_time, end_time=test_shift1.end_time + shift_duration)
...
def test_the_2_extra_shifts_aside_from_the_positions_shifts_amount_are_divided_evenly_between_the_employees():
    ...
    test_shift1 = Shift(shift_id="test_shift1", shift_type=ShiftTypesEnum.MORNING, start_time=test_shift1_start_time, end_time=test_shift1_start_time + shift_duration)
    test_shift2 = Shift(shift_id="test_shift2", shift_type=ShiftTypesEnum.MORNING_BACKUP, start_time=test_shift1.end_time, end_time=test_shift1.end_time + shift_duration)
    test_shift3 = Shift(shift_id="test_shift3", shift_type=ShiftTypesEnum.MORNING_BACKUP, start_time=test_shift2.end_time,  end_time=test_shift2.end_time + shift_duration)
    test_shift4 = Shift(shift_id="test_shift4", shift_type=ShiftTypesEnum.MORNING_BACKUP, start_time=test_shift3.end_time, end_time=test_shift3.end_time + shift_duration)
