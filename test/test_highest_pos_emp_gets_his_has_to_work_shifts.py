...
def test_highest_priority_emp_gets_the_shift_he_wants_and_not_the_mid_priority_emp():
    ...
    highest_priority_emp_preferences = Preferences(shifts_has_to_work_by_id=[ShiftsPreferenceById("morning_shift"), ShiftsPreferenceById("closing_shift")])
...
def test_no_schedule_because_a_higher_emp_wants_parallel_shifts():
    ...
    emp_preferences = Preferences(shifts_has_to_work_by_id=[ShiftsPreferenceById("morning_shift"), ShiftsPreferenceById("closing_shift")])
