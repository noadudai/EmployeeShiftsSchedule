...
def test_verify_no_optimal_solution_when_there_are_more_shifts_then_employees():
    ...
    test_shift1 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.MORNING, start_time=datetime.datetime(2023, 12, 11, 9, 30), end_time=datetime.datetime(2023, 12, 11, 16, 0))
    test_shift2 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.EVENING, start_time=datetime.datetime(2023, 12, 11, 16, 0), end_time=datetime.datetime(2023, 12, 11, 22, 0))
    forbidden_employee = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.CLOSING, start_time=datetime.datetime(2023, 12, 11, 17, 30), end_time=datetime.datetime(2023, 12, 12, 2, 0))

    shifts = [test_shift1, test_shift2, forbidden_employee]
    employees = [test_employee, test_employee2]
...
def test_verify_working_days_for_employee_does_not_exceed_the_max_working_days():
    ...
    start_first_shift_time = datetime.datetime(2023, 12, 12, 18, 0)
    test_shift1 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.MORNING, start_time=start_first_shift_time, end_time=start_first_shift_time + shift_duration)
    test_shift2 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.EVENING, start_time=start_first_shift_time + datetime.timedelta(hours=4), end_time=start_first_shift_time + shift_duration + datetime.timedelta(hours=4))

    start_second_shift_time = start_first_shift_time + datetime.timedelta(days=1)
    test_shift3 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.MORNING, start_time=start_second_shift_time, end_time=start_second_shift_time + shift_duration)
    test_shift4 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.CLOSING, start_time=start_second_shift_time + datetime.timedelta(hours=4), end_time=start_second_shift_time + shift_duration + datetime.timedelta(hours=4))

    start_third_shift_time = start_second_shift_time + datetime.timedelta(days=1)
    test_shift5 = Shift(shift_id=uuid4(), shift_type=ShiftTypesEnum.MORNING, start_time=start_third_shift_time, end_time=start_third_shift_time + shift_duration)
