...
from models.employees.employee_preferences.combined_shifts_preferences import CombinedShiftsPreferences
...
employee1s_preferences = CombinedShiftsPreferences(shifts_wants_to_work=CombinePreferences([ShiftIdPreference(["sunday_morning", "sunday_sb", "monday_morning", "tuesday_sb", "wednesday_morning_backup",
                                                                               "thursday_evening","friday_weekend_morning", "friday_evening", "saturday_weekend_morning", "saturday_evening"])]))

employee2s_preferences = CombinedShiftsPreferences(shifts_cannot_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 4, 28, 6), datetime.datetime(2024, 4, 28, 23, 59)),
                                                                                  DateTimeRangePreference(datetime.datetime(2024, 5, 3, 6), datetime.datetime(2024, 5, 3, 23, 59))]))

employee3s_preferences = CombinedShiftsPreferences(shifts_cannot_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 4, 28, 6), datetime.datetime(2024, 4, 28, 23, 59))]),
                                                   shifts_wants_to_work=CombinePreferences([ShiftIdPreference(["thursday_morning", "thursday_morning_backup", "friday_evening", "friday_weekend_evening_backup", "friday_closing"])]))

employee4s_preferences = CombinedShiftsPreferences(shifts_cannot_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 5, 2, 00), datetime.datetime(2024, 5, 4, 23, 59))]))

employee5s_preferences = CombinedShiftsPreferences(shifts_cannot_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 5, 1, 6), datetime.datetime(2024, 5, 2, 23, 59))]),
                                                   shifts_wants_to_work=CombinePreferences([ShiftIdPreference(["thursday_evening", "thursday_backup", "thursday_closing", "saturday_weekend_morning", "saturday_weekend_morning_backup"])]))

employee6s_preferences = CombinedShiftsPreferences(shifts_prefer_not_to_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 4, 30, 6), datetime.datetime(2024, 4, 30, 23, 59))]),
                                                   shifts_cannot_work=CombinePreferences([DateTimeRangePreference(datetime.datetime(2024, 4, 28, 00), datetime.datetime(2024, 4, 29, 23, 59))]))
