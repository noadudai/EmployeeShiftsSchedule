...
employee1s_preferences = Preferences(shifts_prefer_by_id=ShiftsPreference(["sunday_morning", "sunday_sb", "monday_morning", "tuesday_sb", "wednesday_morning_backup",
...
employee3s_preferences = Preferences(days_cannot_work=[DayOffPreference(datetime.date(2024, 4, 28))],
                                     shifts_prefer_by_id=ShiftsPreference(["thursday_morning", "thursday_morning_backup", "friday_evening", "friday_weekend_evening_backup", "friday_closing"]))
...
employee5s_preferences = Preferences(days_cannot_work=[DayOffPreference(datetime.date(2024, 5, 1))],
                                     shifts_prefer_by_id=ShiftsPreference(["thursday_evening", "thursday_backup", "thursday_closing",  "saturday_weekend_morning", "saturday_weekend_morning_backup"]))
