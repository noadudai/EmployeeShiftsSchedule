...
from .employee_preferences.combined_shifts_preferences import CombinedShiftsPreferences
...
class Employee:
    ...
    shifts_preferences: CombinedShiftsPreferences = field(default_factory=CombinedShiftsPreferences)
